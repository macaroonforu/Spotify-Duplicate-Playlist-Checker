...
def get_access_token(client_id='7b469718056747eeaa34a414e2cd8044', client_secret='18277592f04d4b9b83ed799e4d6e3bf0'): 
...
def main(): 
    ...
    playlist1_id, playlist2_id = input("\x1B[3m" + "Welcome to the duplicate checker! Please enter the two ids of the playlists you would like to compare: " + "\x1B[0m").split() 
    ...
    if dups: 
        print('\n' + f"Here are the duplicate tracks between {playlist1_name} and {playlist2_name}.")
        for item in dups: 
